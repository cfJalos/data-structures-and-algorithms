...
const mapCurrentEvents = () => currentEvents.news.map(data => new Event(data));
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let data = arr.reduce((accumulator) => {
    accumulator += 1;
    return accumulator;
  });
...
const reversedString = (str) => {
  ...
  let results = array.reduce((value, accumulator) => {
